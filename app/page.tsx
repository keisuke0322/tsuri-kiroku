...
export default async function Home(){
 ...
 return <FishingLog canManageDemo={await canManageDemo(user.userId)} userId={user.userId} initialName={initialName} signOutPath={chatGPTSignOutPath('/')} signInPath={chatGPTSignInPath('/')}/>;
}
